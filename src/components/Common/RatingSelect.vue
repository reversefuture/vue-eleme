...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created(){
      ...
      this.$_selectType = this.onlyContent
    },
    computed: {
      positives() {
    ...
    methods: {
      select(type, event) {
        ...
        this.$help.$emit('ratingtype.select', {type});
      },
      toggleContent(event) {

        // this.$_onlyContent = !this.onlyContent;
        this.$help.$emit('content.toggle', {onlyContent: this.$_onlyContent});
      }
    }
  };
</script>
