<template>
	<div class="header">
		<div class="content-wrapper">
			<div class="avatar">
				<img :src="seller.avatar" alt="header" width="64" height="64">
			</div>
			<div class="content">
				<div class="title">
	...
	<div class="background"><img :src="seller.avatar" alt="background" ></div>
...
export default {
  ...
  watch: {
    seller(val, oldVal) {
     if (val.description !== oldVal.description) {
     	this.seller = val
     }
   }
	},
